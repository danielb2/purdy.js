...
internals.Boolean = function(bool) {
    ...
    if (bool === true) {
        return (bool + '').green.bold;
    }
    return (bool + '').red.bold;
};


internals.RegExp = function(regexp) {

    return (regexp + '').magenta;
};
...
internals.Undefined = function() {
    return (undefined + '').red.inverse;
};
